...
export default function SocialAuthButtons({
  ...
  // Hide on Android and Web (per App Store guidelines, Apple Sign-In is required on iOS if other social logins are offered)
  // We use useEffect because Capacitor.getPlatform() returns 'web' during SSR
  useEffect(() => {
    const isIOS = Capacitor.getPlatform() === "ios";
    setShowAppleButton(isIOS);
  }, []);
