/**
 * FlameIcon - Fire emoji SVG icon for streak feature
 * Uses the same fire design as the main streak flame
 * Animated and responsive to size prop
 */
    ...
    >
      ...
      >
        <defs>
          <style>{`
            .flame-icon-outer {
              animation: flame-icon-sway 3s ease-in-out infinite;
              transform-origin: 64px 110px;
              transform-box: fill-box;
            }
            .flame-icon-inner {
              animation: flame-icon-flicker 0.4s ease-in-out infinite;
            ...
            @media (prefers-reduced-motion: reduce) {
              .flame-icon-outer, .flame-icon-inner { animation: none !important; }
            }
          `}</style>
        </defs>
