import { Wheat, Nut } from "lucide-react";

type NutrientKey = "protein" | "carbs" | "fat";
...
// Custom Protein Drumstick Icon
function ProteinIcon({ className = "w-7 h-7", color = "currentColor", ...props }: { className?: string; color?: string; "aria-hidden"?: boolean; role?: string }) {
  return (
    <svg
...
export function NutrientIcon({
  ...
  switch (kind) {
    case "protein":
      return <ProteinIcon {...commonProps} />;
    case "carbs":
      return <Wheat {...lucideProps} />;
    case "fat":
      return <Nut {...lucideProps} />;
    default:
      return null;
  }
}
